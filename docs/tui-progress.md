...
This document describes how `drot` reports progress in the interactive TUI (and shares the same state machine with direct-mode stderr counters). It is written for agents and operators who need to extend workflows without relying on chat history.
